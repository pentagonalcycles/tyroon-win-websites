...
export const metadata: Metadata = {
  title: 'Our Tax Barristers',
  description:
    'A select group of experienced barristers specialising in tax appeals and HMRC disputes. Contact Tyroon Win to discuss barrister availability and suitability.',
};
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Specialist Tax Counsel"
        description="A select group of experienced tax barristers."
      />
          ...
          <div className="max-w-5xl mx-auto">
            <div className="max-w-3xl mb-10">
              <p className="text-lg text-gray-700 leading-relaxed">
                I work with a select group of experienced barristers who specialise in tax
                appeals, HMRC disputes, and First-tier Tribunal matters. Each barrister is
                chosen for their expertise, approachability, and track record of success.
              </p>
            </div>
            ...
            <div className="bg-cream rounded-2xl p-8 text-center border border-accent/20">
              ...
              <p className="text-gray-600 mb-6 max-w-xl mx-auto">
                I will match you with the most suitable tax barrister based on your specific
                matter, budget, and timeline. Contact me for a no-obligation initial discussion.
              </p>
              <Link
                href="/contact"
