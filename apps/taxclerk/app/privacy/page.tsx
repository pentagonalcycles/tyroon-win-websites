...
export const metadata: Metadata = {
  ...
  description:
    'Privacy policy for taxclerk.co.uk — how we collect, use, and protect your personal data under GDPR.',
};
      ...
      <Section background="white">
        <Container>
          <div className="max-w-3xl mx-auto prose prose-gray prose-headings:font-heading prose-a:text-primary">
            ...
            <p>
              The data controller for this website is Tyroon Win, operating as a tax clerk.
            </p>
            <p>
              <strong>Email:</strong>{' '}
              <a href="mailto:tyroon.win@taxclerk.co.uk">tyroon.win@taxclerk.co.uk</a>
            </p>
            ...
            <ul>
              ...
              <li>Information about your tax matter provided in contact forms</li>
            ...
            <ul>
              <li>Respond to your enquiries about tax barrister instruction</li>
            ...
            <ul>
              ...
              <li><strong>Erasure</strong> (&ldquo;right to be forgotten&rdquo;) in certain circumstances</li>
              <li><strong>Restriction</strong> of processing in certain circumstances</li>
              <li><strong>Data portability</strong> for data you have provided</li>
