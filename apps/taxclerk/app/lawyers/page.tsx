            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
              <div className="lg:col-span-3 space-y-6">
                <p className="text-lg text-gray-700 leading-relaxed">
                  You need clear answers on availability, fees, and suitability. You also need
                  confidence that counsel understands the commercial context, not just the law.
                  I act as your first point of contact and make the process straightforward.
                </p>
                ...
                <p className="text-gray-700 leading-relaxed">
                  I understand the pressures you are under. Deadlines move. Clients expect
                  clarity. My role is to remove friction and keep things moving.
                </p>
                <p className="text-gray-700 leading-relaxed">
