...
export const metadata: Metadata = {
  ...
  description:
    'Specialist tax barrister representation in First-tier Tribunal appeals and HMRC disputes. Precision preparation for individuals, businesses, and professional advisers.',
};
...
export default function TaxPage() {
  ...
  return (
    <>
      <PageHero
        title={tc.title}
        subtitle="Specialist Tax Appeals"
      ...
      <Section background="white">
        <Container>
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div>
              {tc.intro.split('\n\n').map((para, i) => (
                <p key={i} className="text-gray-700 leading-relaxed mb-4 last:mb-0 text-lg">
                  {para}
                </p>
              ))}
            </div>
            ...
            <div className="bg-primary text-white rounded-2xl p-8">
              <h2 className="font-heading text-2xl font-bold mb-4">
                Ready to Discuss Your Tax Appeal?
              </h2>
